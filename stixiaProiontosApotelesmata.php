        ...
        <div class="container">
        	<div class="row">
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-Name" ></label>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-CommName" ></label>
                    <div class="col-md-6 "></div> 
                </div>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-use"></label>
                    <div class="col-md-6 "></div> 
                </div>
                ...
                <br><br>
                 ...
                 <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-extraChar"></label>
                    <div class="col-md-6 "></div> 
                </div>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-state"></label>
                    <div class="col-md-6 "></div> 
                </div>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-storageAdd" ></label>
                   <div class="col-md-6 "></div> 
                </div>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-SDS" ></label>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-CPL" ></label>
                    <div class="col-md-6 "></div> 
                </div>
                ...
                <div class="col-md-12 ">
                    ...
                    <label class="col-md-3 " id="chemicalProduct-V"></label>
                    <div class="col-md-6 "></div> 
                </div>
                                <br><br>
                                <br><br>
