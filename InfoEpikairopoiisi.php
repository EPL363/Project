...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p data-toggle="modal" data-target="#chemicalModal">sdfsfsfsfsfs</p>
            <!-- Modal -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title" id="chemicalModalLabel">Πληροφορίες Σχετικά με την Επικαιροποίηση Στοιχείων Προϊόντος</h4>
                  </div>
