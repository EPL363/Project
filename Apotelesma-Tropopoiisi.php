                ...
                <div class="col-md-12 column">
                   ...
                   <div role="tabpanel">
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                          <li role="presentation"><a href="#prosthiki" aria-controls="prosthiki" role="tab" data-toggle="tab">Τροποποίηση Στοιχείων Προϊόντος</a></li>
                        
                      </ul>

                      <!-- Tab panes -->
                      <div class="tab-content" style="height:100%">
                         <div role="tabpanel" class="tab-pane active" id="prosthiki"></div>
