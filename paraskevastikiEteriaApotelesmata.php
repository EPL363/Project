        ...
        <div class="col-md-12 column" id="paraskevastiki_form"> 
            ...
            <div class="row">
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-Name" ></label>
                    <label class="col-sm-3 control-label" for="constEmpl-name">Όνομα:</label>
                    <label  class="col-sm-3" id="constEmpl-name" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-CommercialName"></label>
                    <label class="col-sm-3 control-label" for="constEmpl-Surname">Επίθετο:</label>
                    <label  class="col-sm-3" id="constEmpl-Surname" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-OtherName" ></label>
                     <label class="col-sm-3 control-label" for="constEmpl-address">Διεύθυνση:</label>
                    <label  class="col-sm-3" id="constEmpl-address" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-legalForm" ></label>
                     <label class="col-sm-3 control-label" for="constEmpl-pc">T.K. :</label>
                    <label  class="col-sm-3" id="constEmpl-pc" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-CEO" ></label>
                    <label class="col-sm-3 control-label" for="constEmpl-city">Πόλη:</label>
                    <label  class="col-sm-3" id="constEmpl-city" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-Address" ></label>
                    <label class="col-sm-3 control-label" for="constEmpl-fax">Φάξ:</label>
                    <label  class="col-sm-3" id="constEmpl-fax" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-PC" ></label>
                     <label class="col-sm-3 control-label" for="constEmpl-phone">Τηλέφωνο:</label>
                    <label  class="col-sm-3" id="constEmpl-phone" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-City" ></label>
                     <label class="col-sm-3 control-label" for="constEmpl-email">Ηλεκτρονικό Ταχυδρομείο:</label>
                    <label  class="col-sm-3" id="constEmpl-email"></label>
                ...
                <br>
                 ...
                 <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-country" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-Phone" ></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-fax"></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label  class="col-sm-3" id="constCompany-email"></label>
                ...
                <div class="col-md-12 column">
                    ...
                    <label class="col-sm-3" id="constCompany-info"></label>
